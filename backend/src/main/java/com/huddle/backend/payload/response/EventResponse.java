...
public class EventResponse {
    ...
    public EventResponse(Long id, String name, TeamResponse team, OffsetDateTime startTime, OffsetDateTime endTime, EEvent eventType, Integer teamScore, Integer opponentScore) {
        this.id = id;
        this.name = name;
        this.team = team;
